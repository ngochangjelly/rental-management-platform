    ...
    en: {
      translation: {
        ...
        docs: {
          ...
          noDocumentsDesc: "Start by creating your first document",
        ...
        propertyMoveoutTimeline: {
          title: "Property Lease Expiry Timeline",
          hint: "Click to expand — shows when leases expire and preparation deadlines",
          loading: "Loading...",
          loadError: "Error loading data. Please try again.",
          noProperties: "No properties available",
          selectProperty: "Select at least one property to view the timeline.",
          ...
          urgent: "urgent",
          statUrgent: "< 3 months",
          statWarning: "3–6 months",
          statNoExpiry: "no expiry set",
          legendUrgent: "< 3 months (urgent)",
          legendWarning: "3–6 months",
          legendSafe: "> 6 months",
          legendExpired: "Expired",
          legendNoExpiry: "No expiry set",
        },
        tenancyOccupancy: {
        ...
        billManagement: {
          ...
          cleaningSubsidized: "Cleaning Subsidized",
          ...
          movedOutNoBill: "Moved out – not in bill",
          notBilledBadge: "Not billed",
        ...
        utilityBillTracker: {
          ...
          subtitle:
            "Track SP Group monthly bills — electricity, water & gas per property",
          addBill: "Add Bill",
          back: "Back",
          ...
          dropZoneSubHint:
            "Supports JPEG, PNG, HEIC — bill data will be parsed automatically",
          year: "Year",
          month: "Month",
          billDate: "Bill Date",
          ...
          missingCount_one:
            "{{count}} property missing — click below to fill in",
          missingCount_other:
            "{{count}} properties missing — click below to fill in",
          noBillsRecorded:
            "No bills recorded yet. Upload your first SP Group bill above.",
          colMonth: "Month",
          ...
          deleteConfirm:
            "Delete this utility bill record? This cannot be undone.",
          ...
          breakdownAwayNote:
            "Away days from the Tenancy Occupancy module are deducted from each tenant's occupied days before calculating their share.",
          breakdownNoTenants:
            "No tenants found for this property during the billing period.",
          breakdownFooterTotal: "Total",
          breakdownAmountsNote:
            "Amounts above cover the full utility bill (electricity + water + gas & others).",
        ...
        salesMap: {
          ...
          panelTitle: "Property Details",
          hoverHint: "Hover or click a marker to view room details",
          available: "Available",
          occupied: "Occupied",
          occupancy: "Occupancy",
          noRooms: "No rooms configured for this property",
          noCoords: "No map coordinates. Click below to geocode from postcode.",
          geocode: "Geocode",
          geocoding: "Geocoding...",
          geocodeSuccess: "Coordinates saved",
          geocodeFailed: "Geocoding failed. Check postcode.",
          missingCoords: "{{count}} propert(ies) have no map coordinates",
          properties: "properties",
          roomsAvailable: "rooms available",
          statTotal: "Total Properties",
          statRoomsAvail: "Rooms Available",
          statRoomsOccup: "Rooms Occupied",
          retry: "Retry",
        },
      },
    },
    vi: {
      translation: {
        sidebar: {
          ...
          salesMap: "Bản đồ bán hàng",
          loggedInAs: "Người đăng nhập:",
          logout: "Đăng xuất",
        },
        docs: {
          title: "Tài Liệu Quy Trình",
          newDoc: "Tạo tài liệu quy trình mới",
          searchPlaceholder: "Tìm kiếm tài liệu quy trình...",
          noDocuments: "Chưa có tài liệu quy trình",
          noDocumentsDesc: "Bắt đầu bằng cách tạo tài liệu quy trình đầu tiên",
          noResults: "Không tìm thấy tài liệu quy trình",
          ...
          exporting: "Đang xuất...",
          deleteDoc: "Xóa",
          confirmDelete: "Xóa tài liệu này? Không thể hoàn tác.",
          docDeleted: "Đã xóa tài liệu",
          deleteFailed: "Xóa thất bại",
          backToList: "Quay lại Tài liệu",
          titlePlaceholder: "Tiêu đề tài liệu",
          editorPlaceholder: "Bắt đầu nhập nội dung...",
          loadFailed: "Tải tài liệu thất bại",
          createFailed: "Tạo tài liệu thất bại",
          tags: "Nhãn",
          tagsPlaceholder: "Thêm nhãn (cách nhau bằng dấu phẩy)",
          justNow: "Vừa xong",
        ...
        propertyMoveoutTimeline: {
          title: "Lịch Hết Hạn Thuê Nhà",
          hint: "Nhấn để mở — hiển thị ngày hết hạn hợp đồng và thời hạn chuẩn bị",
          loading: "Đang tải...",
          loadError: "Lỗi tải dữ liệu. Vui lòng thử lại.",
          noProperties: "Không có nhà nào",
          selectProperty: "Chọn ít nhất một nhà để xem lịch.",
          propertiesSelected: "nhà được chọn",
          selectAll: "Tất cả",
          selectNone: "Bỏ chọn",
          property: "Nhà",
          moveIn: "Ngày vào",
          moveOut: "Ngày trả",
          noExpiry: "Chưa có ngày",
          months: "tháng",
          urgent: "khẩn cấp",
          statUrgent: "< 3 tháng",
          statWarning: "3–6 tháng",
          statNoExpiry: "chưa có ngày hết hạn",
          legendUrgent: "< 3 tháng (khẩn cấp)",
          legendWarning: "3–6 tháng",
          legendSafe: "> 6 tháng",
          legendExpired: "Đã hết hạn",
          legendNoExpiry: "Chưa có ngày hết hạn",
        },
        tenancyOccupancy: {
        ...
        billManagement: {
          ...
          cleaningSubsidized: "Được hỗ trợ vệ sinh",
          ...
          movedOutNoBill: "Đã rời đi – chưa có hóa đơn",
          notBilledBadge: "Chưa lập HĐ",
        ...
        utilityBillTracker: {
          ...
          subtitle:
            "Theo dõi hóa đơn SP Group hàng tháng — điện, nước & gas mỗi nhà",
          addBill: "Thêm hóa đơn",
          back: "Quay lại",
          ...
          dropZoneSubHint:
            "Hỗ trợ JPEG, PNG, HEIC — dữ liệu sẽ được đọc tự động",
          year: "Năm",
          month: "Tháng",
          ...
          missingCount_other:
            "{{count}} nhà còn thiếu — click bên dưới để điền",
          noBillsRecorded:
            "Chưa có hóa đơn nào. Hãy tải lên hóa đơn SP Group đầu tiên.",
          colMonth: "Tháng",
          ...
          breakdownTotal: "Tổng:",
          breakdownAwayNote:
            "Ngày vắng từ module Quản lí trống phòng được trừ trước khi tính tỷ lệ.",
          breakdownNoTenants:
            "Không tìm thấy người thuê trong kỳ tính tiền này.",
          breakdownFooterTotal: "Tổng",
          breakdownAmountsNote:
            "Số tiền trên bao gồm toàn bộ hóa đơn (điện + nước + gas & khác).",
          breakdownClose: "Đóng",
          selectAll: "Chọn tất cả",
        },
        salesMap: {
          title: "Bản đồ bán hàng",
          legend: "Chú thích",
          hdb: "HDB",
          condo: "Căn hộ",
          all: "Tất cả",
          loading: "Đang tải dữ liệu bản đồ...",
          panelTitle: "Chi tiết nhà",
          hoverHint: "Di chuột hoặc nhấn vào điểm để xem phòng",
          available: "Còn trống",
          occupied: "Đã thuê",
          occupancy: "Lấp đầy",
          noRooms: "Nhà này chưa có danh sách phòng",
          noCoords: "Chưa có toạ độ bản đồ. Nhấn bên dưới để tự động định vị.",
          geocode: "Định vị",
          geocoding: "Đang định vị...",
          geocodeSuccess: "Đã lưu toạ độ",
          geocodeFailed: "Định vị thất bại. Kiểm tra mã bưu chính.",
          missingCoords: "{{count}} nhà chưa có toạ độ bản đồ",
          properties: "nhà",
          roomsAvailable: "phòng trống",
          statTotal: "Tổng số nhà",
          statRoomsAvail: "Phòng còn trống",
          statRoomsOccup: "Phòng đã thuê",
          retry: "Thử lại",
        },
      },
    },
